...
Student name: Achirawich Jirakulphan
...
1. If `Cm_alpha < 0` and the angle-of-attack disturbance is positive, `delta_Cm` should be negative because Cm_alpha = delta_Cm/angle-of-attack.
2. If `Cm_alpha > 0` and the angle-of-attack disturbance is positive, the response should be positive because Cm_alpha = delta_Cm/angle-of-attack.
3. If `Cm_alpha = 0`, changing angle of attack should not create any restore or destabilization.
